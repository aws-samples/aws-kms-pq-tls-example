...
$ git clone https://github.com/alexw91/aws-sdk-java-v2.git --branch aws_crt
$ # TODO use this instead git clone https://github.com/aws/aws-sdk-java-v2.git --branch aws-crt-dev-preview
$ cd aws-sdk-java-v2
